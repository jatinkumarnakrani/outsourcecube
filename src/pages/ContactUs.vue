...
<template>
    <ShellHeroLegel
        ...
        :img="{ src: websiteStore.getImagePath(contactUs?.heading.bannerImg), alt: 'Illustration', class:['lg:ms-auto lg:me-20', 'h-120', 'mx-auto d-block'], imgSectionClass:['order-first','w-1/2'] , firstDivClass:['w-1/2'] }"
    />
